<?php if(isset($_SESSION['logged_in'])):?>
         ...
         <div class="row-product row-in-margin" >
           ...
           <div class="row-product-in">
            ...
            <div class="row-inner">
              ...
              <div class="row-outer">
              <img src="<?php echo base_url(); ?>assets/img/meigo.jpg">
              <h6 title="<?php echo $items['name']; ?>" data-toggle="tooltip" data-placement="bottom"><?php echo substr($items['name'],0,40); ?></h6>
 ...
 <hr style="width: 80%;height: 0.5%;border-bottom: none;border-top-color:#d1d1d1; "> 
            ...
            <div  class="form-group time-group"  style="display: flex;flex-direction: row-reverse;" >  
